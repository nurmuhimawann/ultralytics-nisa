...
__all__ = ('DFL', 'HGBlock', 'HGStem', 'SPP', 'SPPF', 'C1', 'C2', 'C3', 'C2f', 'C3x', 'C3TR', 'C3Ghost',
           ...
           ,'FusedMBConv','MBConv', 'GhostC2f', 'ConvNextC2f')
...
class ConvNextC2f(C2f):
    """C2f module with ConvNext bottleneck."""
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        """Initialize ConvNextC2f instance and set default parameters."""
        super().__init__(c1, c2, n, shortcut, g, e)
        self.cv1 = Block(c1, 2 * self.c, 1, 1)
        self.cv2 = Block((2 + n) * self.c, c2, 1)
        self.m = nn.ModuleList(GhostBottleneck(self.c, self.c, shortcut, g) for _ in range(n))
